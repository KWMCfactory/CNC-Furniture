...
total_items = bench_quant + table_quant + chair_quant + rocking_quant + hedgehog_quant + library_quant + planter_quant
cut_cost_low = total_items * 50
cut_cost_high = total_items * 100
